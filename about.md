...
<div class="page-head">
  ...
  <h1 class="page-title">About The Observer</h1>
...
<table class="desks">
  ...
  <tbody>
    <tr><td><strong>The Wire</strong></td><td>Raw dated signals — captured while findable. Internal; feeds the editor.</td><td>Daily</td></tr>
