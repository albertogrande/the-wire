...
*Deep dive · 2026-06-12 · Two npm worms beat code review, signed provenance, and install-script scanning in one week. Here's why every layer failed, and what actually changes now.*
...
The reason is a functioning market. "LLMjacking" — [named by Sysdig in 2024](https://www.sysdig.com/blog/llmjacking-stolen-cloud-credentials-used-in-new-ai-attack) — has matured: stolen LLM credentials sell for $15–30 at the low end, one marketplace listing showed 417 OpenAI credentials averaging $450 each with a 23-day usable lifespan (single-sourced; treat the precision loosely), and victims can burn up to $100K a day in stolen compute. The [pricing dive](./2026-06-11-ai-coding-honest-pricing.md) argued that metering turned tokens into money. Criminals agree. An API key in your CI is no longer config. It's cash in an unlocked drawer.
